...
def main():
    ...
    try:
        ...
        print("🎯 Strategia: M5/M15 - Professional Multi-Indicator Analysis")
        print("=" * 60)
        print("🔧 Funkcje:")
        ...
        print("   • SMI Arrows - stochastic momentum")
        print("   • RSI Professional - overbought/oversold z dywergencjami")
        print("   • Bollinger Bands - volatility analysis z squeeze/expansion")
